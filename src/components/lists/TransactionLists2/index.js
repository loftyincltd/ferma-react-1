...
const TransactionListItem = (props) => {
  const { last_name, first_name, username, state, district,fingerprintdata } = props;
  console.log("transaction list",props)
  ...
  return (
    <div className="TransactionLists-Item" onClick={revealDetail}>
      <div className="detail">
        ...
        <h5 style={{color:'red'}}>Fingerprint: {fingerprintdata.length?'Acquired':'N/A'} </h5>
